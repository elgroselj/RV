...
import sys
sys.path.append(".")
from my import lucaskanade
im1 = np.random.rand(200 ,200).astype( np.float32 )
im2 = im1.copy()
im2 = rotate_image(im2 , -1)
U_lk, V_lk = lucaskanade(im1, im2, 3, SIG=0.5)
# U_hs , V_hs = horn_schunck ( im1 , im2 , 1 0 0 0 , 0 . 5 )
...
# ax2_11 . imshow ( im1 )
# ax2_12 . imshow ( im2 )
# show_flow ( U_hs , V_hs , ax2_21 , t y pe= ' a n g l e ' )
# show_flow ( U_hs , V_hs , ax2_22 , t y pe= ' f i e l d ' , set_aspect=True )
# fig2 . suptitle ( ' Horn−Schunck O p t i c a l Flow ' )
plt.show()